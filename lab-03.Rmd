...
author: "Sami Munawar, Yining Zhao, User3 and User4 - Team Name"
date: "`r Sys.Date()`"
...
long format has multple rows for each case and wide format variables occuply a single column   

Is the format `staff` data *wide* or *long*?

format of 'staff' is wide
